const FProductCardSkeleton = () => (
  <div className="group relative flex flex-col overflow-hidden rounded-xl border border-slate-200/50 dark:border-slate-700/50 bg-white/60 dark:bg-slate-800/60 backdrop-blur-lg shadow min-w-0 w-full h-full p-2 sm:p-3 lg:p-4 animate-pulse">
