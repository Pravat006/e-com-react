...
const YourOrder = () => {
  ...
  const allOrders = [
    {
      id: 1,
      image: 'https://placehold.co/96x96/0000FF/FFFFFF?text=Oil',
      name: 'BAJAJ 100% Pure Coconut Hair Oil',
      price: 312,
      status: 'Delivered',
      statusDate: 'Apr 16',
      orderTime: '2024',
    ...
    {
      id: 2,
      image: 'https://placehold.co/96x96/0000FF/FFFFFF?text=Refrigerator',
      name: 'SAMSUNG 183 L, Direct Cool Single Door 4...',
      color: 'Blue',
      price: 15690,
      status: 'Delivered',
      statusDate: 'Apr 16',
    ...
    {
      id: 3,
      image: 'https://placehold.co/96x96/FF00FF/FFFFFF?text=Refrigerator',
      name: 'SAMSUNG 183 L, Direct Cool Single Door 4...',
      color: 'Purple',
      price: 15719,
      status: 'Cancelled',
      statusDate: 'Apr 14',
      cancellationReason: 'You requested a cancellation because of issues with the delivery date.',
      orderTime: '2024',
    },
    {
      id: 4,
      image: 'https://placehold.co/96x96/008000/FFFFFF?text=Trolley',
      name: 'ALFA VIP Rhino - 55 Hardbody Trolley...',
      color: 'Green',
      price: 1294,
      status: 'Cancelled',
      statusDate: 'Apr 03',
    ...
    {
      id: 5,
      image: 'https://placehold.co/96x96/00CED1/FFFFFF?text=Suitcase',
      name: 'Safari Fury 55 Cabin Suitcase 4 Wheels -...',
      color: 'Teal',
      price: 1389,
      status: 'Delivered',
      statusDate: 'Mar 28',
    ...
    {
      id: 6,
      image: 'https://placehold.co/96x96/FFA500/FFFFFF?text=Gift+Card',
      name: 'Flipkart Digital Gift Card',
      price: 25,
      status: 'Delivered',
      statusDate: 'Mar 20',
      orderTime: '2024',
    ...
    {
      id: 7,
      image: 'https://placehold.co/96x96/800080/FFFFFF?text=Book',
    ...
    {
      id: 8,
      image: 'https://placehold.co/96x96/4682B4/FFFFFF?text=Headphones',
      name: 'Wireless Bluetooth Headphones',
      price: 1200,
      status: 'On the way',
      statusDate: 'Expected Jun 5',
      orderTime: 'Last 30 days',
    },
  ];

  // Filter logic
  const filteredOrders = allOrders.filter((order) => {
    const matchesStatus = filters.status === '' || order.status === filters.status; // Compare single value
    const matchesTime = filters.time === '' || order.orderTime === filters.time; // Compare single value
    const matchesSearch =
      filters.searchTerm === '' ||
      order.name.toLowerCase().includes(filters.searchTerm.toLowerCase()) ||
      (order.id && order.id.toString().toLowerCase().includes(filters.searchTerm.toLowerCase()));
